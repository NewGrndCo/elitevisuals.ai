    ...
    <>
      ...
      <main className="grid min-h-[60vh] place-items-center px-6 pt-28 text-center">
        <div>
          ...
          <Link to="/library" className="mt-4 inline-block text-sm text-[#a78bfa] underline">
            Back to library
          </Link>
        </div>
      </main>
        ...
        {!hidden.has("hero") && (
          <section className="mx-auto max-w-5xl px-6 text-center">
            ...
            <h1 className="font-display text-4xl font-extrabold tracking-[-0.04em] sm:text-6xl">
              <span className="text-gradient">{pack?.title ?? "Loading…"}</span>
            </h1>
          ...
          <section className="mx-auto mt-12 max-w-6xl space-y-16 px-6">
            ...
            {(() => {
              ...
              return (
                <div>
                  <div className="mb-5">
                    <h2 className="font-display text-2xl font-bold lowercase">other</h2>
                  </div>
              ...
              {[
                {
                  icon: Sparkles,
                  title: "Pick a prompt",
                  desc: "Browse the prompts and copy the one you want.",
                },
                {
                  icon: UploadCloud,
                  title: "Upload your frame",
                  desc: "Drop your starting image into your AI video model of choice.",
                },
                {
                  icon: Play,
                  title: "Generate motion",
                  desc: "Paste, run, and refine until the transition lands.",
                },
              ].map((s, i) => (
