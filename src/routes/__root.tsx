  ...
  head: () => ({
    meta: [
      ...
      { title: "Elite Visuals — Premium AI Visual Prompts" },
      {
        name: "description",
        content:
          "A curated library of premium AI video and image prompts: temporal, particle, fluid, and energy effects rendered in glassmorphic detail.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8a306304-f538-4e2a-8ca2-721ebb13c5bb/id-preview-61894671--06cd7a4b-2e5e-441b-9069-efe39637957f.lovable.app-1780122702881.png",
      },
      {
        name: "twitter:image",
        content:
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Toaster theme="light" position="bottom-right" toastOptions={{ className: "glass" }} />
    </QueryClientProvider>
  );
}
